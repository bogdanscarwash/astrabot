...
class TwitterExtractor:
    ...
    def analyze_sentiment(self, text: str) -> str:
        ...
        positive_indicators = ['love', 'great', 'awesome', 'excellent', 'amazing', 'wonderful', 
                              'fantastic', 'brilliant', 'perfect', '😊', '😄', '❤️', '👍', '🎉']
        negative_indicators = ['hate', 'terrible', 'awful', 'horrible', 'bad', 'worst', 
