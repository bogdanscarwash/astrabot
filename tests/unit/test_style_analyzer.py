...
class TestStyleAnalyzer:
    ...
    def test_classify_communication_style(self, analyzer):
        ...
        style_data = {"avg_message_length": 25.5, "burst_frequency": 0.7, "emoji_frequency": 0.3}
        ...
        assert style in [
            ...
            "lengthy_texter",
            "concise_texter",
            "expressive_communicator",
            "formal_correspondent",
        ]
    ...
    def test_analyze_all_communication_styles(self, analyzer, sample_messages_df, recipients_df):
        ...
        for recipient_id in [3, 4, 5]:
            for i in range(60):  # Minimum 50 messages required
                extended_messages.append(
                    {
                        "body": f"Message {i} to recipient {recipient_id}"
                        + ("😊" if i % 3 == 0 else ""),
                        "from_recipient_id": 2,
        ...
        styles = analyzer.analyze_all_communication_styles(messages_df, recipients_df)
