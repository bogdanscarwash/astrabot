...
class TestAstrabotLogger:
    ...
    def test_log_rotation(self):
        ...
        setup_logging(
            log_file=self.log_file, max_bytes=100, backup_count=2  # Very small to force rotation
        )
        logger = get_logger("test")
    ...
    def test_context_manager(self):
        ...
        with logger.context(conversation_id="conv_123", user_id="user_456"):
            ...
            # Nested context
            with logger.context(
                message_id="msg_789", tweet_url="https://twitter.com/user/status/123"
            ):
    ...
    def test_training_data_creation_metadata(self):
        ...
        logger.info(
            ...
            extra={
                ...
                "filter_reasons": {"too_short": 100, "no_context": 50},
    ...
    def test_style_analysis_metadata(self):
        ...
        logger.info(
            ...
            extra={
                ...
                "personality_traits": {"humor": 0.8, "formality": 0.3, "enthusiasm": 0.7},
            },
        )
    ...
    def test_json_with_nested_metadata(self):
        ...
        logger.info(
            ...
            extra={
                ...
                "performance": {"total_time": 5.2, "avg_per_message": 0.052},
                "errors": [],
            },
        )
    ...
    def test_concurrent_logging(self):
        ...
        def log_batch(source_id):
            try:
                for i in range(20):
                    logger.info(
                        f"Message from source {source_id}",
                        extra={"source": source_id, "message_num": i, "timestamp": time.time()},
                    )
