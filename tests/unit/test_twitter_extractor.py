...
from src.models.schemas import TweetContent
...
class TestTwitterExtractor:
    ...
    def test_convert_nitter_to_twitter_image_url(self, extractor):
        ...
        for nitter_url in nitter_urls:
            ...
            assert (
                "test.jpg" in twitter_url
                or "image.png" in twitter_url
                or "photo.gif" in twitter_url
            )
    ...
    def test_url_validation(self, extractor):
        ...
        invalid_urls = ["https://facebook.com/post/123", "not-a-url", None, ""]
