...
from src.models.schemas import EnhancedMessage, TweetContent
...
class TestTrainingDataCreator:
    ...
    def test_create_conversational_training_data(self, creator, sample_conversation_messages):
        ...
        training_data = creator.create_conversational_training_data(
            sample_conversation_messages, context_window=2, your_recipient_id="2"
        )
    ...
    def test_create_adaptive_training_data(self, creator, sample_conversation_messages):
        ...
        training_data = creator.create_adaptive_training_data(
            sample_conversation_messages, your_recipient_id="2"
        )
        ...
        assert (
            "conversation partner" in system_msg["content"].lower()
            or "adapt" in system_msg["content"].lower()
        )
    ...
    def test_handle_twitter_content(self, creator, sample_message_with_twitter):
        ...
        training_data = creator.create_conversational_training_data(
            [sample_message_with_twitter], your_recipient_id="2"
        )
    ...
    def test_filter_by_quality(self, creator, sample_conversation_messages):
        ...
        training_data = creator.create_conversational_training_data(
            all_messages, your_recipient_id="2", min_message_length=3
        )
    ...
    def test_context_window_handling(self, creator, sample_conversation_messages):
        ...
        for context_size in [1, 2, 3, 5]:
            training_data = creator.create_conversational_training_data(
                sample_conversation_messages, context_window=context_size, your_recipient_id="2"
            )
            ...
            for example in training_data:
                total_conversation_msgs = len(
                    [msg for msg in example["messages"] if msg["role"] in ["user", "assistant"]]
                )
    ...
    def test_deduplication(self, creator):
        ...
        training_data = creator.create_conversational_training_data(
            duplicate_messages, your_recipient_id="2", deduplicate=True
        )
    ...
    def test_format_for_different_models(self, creator, sample_conversation_messages):
        ...
        for template in templates:
            try:
                training_data = creator.create_conversational_training_data(
                    sample_conversation_messages, your_recipient_id="2", chat_template=template
                )
    ...
    def test_metadata_preservation(self, creator, sample_conversation_messages):
        ...
        training_data = creator.create_conversational_training_data(
            sample_conversation_messages, your_recipient_id="2", include_metadata=True
        )
    ...
    def test_empty_input_handling(self, creator):
        ...
        empty_training_data = creator.create_conversational_training_data([], your_recipient_id="2")
    ...
    def test_batch_processing(self, creator, sample_conversation_messages):
        ...
        training_data = creator.create_conversational_training_data(
            large_dataset, your_recipient_id="2", batch_size=10
        )
