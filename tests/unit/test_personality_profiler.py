...
from src.models.conversation_schemas import (
    RelationshipDynamic, ConversationDynamics, MessageTiming,
...
class TestPersonalityProfiler:
    ...
    def test_relationship_dynamics_analysis(self, profiler, sample_messages_df):
        ...
        academic_dynamic = profiler.analyze_relationship_dynamics(
            sample_messages_df, '2', '3'
        )
        ...
        casual_dynamic = profiler.analyze_relationship_dynamics(
            sample_messages_df, '2', '4'
        )
    ...
    def test_personality_profile_generation(self, profiler, sample_messages_df, sample_recipients_df):
        ...
        assert profile.message_style in [
            'rapid_burst', 'verbose_burst', 'long_form', 'concise', 'balanced'
        ]
    ...
    def test_conversation_style_profile_generation(self, profiler, sample_messages_df, sample_recipients_df):
    ...
    def test_communication_adaptation_analysis(self, profiler, sample_messages_df):
        ...
        adaptations = profiler.analyze_communication_adaptation(
            sample_messages_df, '2'
        )
    ...
    def test_signature_phrase_detection(self, profiler):
        ...
        df = pd.DataFrame({
            ...
            'date_sent': [1640995200000 + i*60000 for i in range(len(messages_with_signatures))]
        })
        
        recipients_df = pd.DataFrame({
            '_id': ['2'],
            'profile_given_name': ['TestUser']
        })
    ...
    def test_emoji_preference_integration(self, profiler, sample_messages_df, sample_recipients_df):
        ...
        profile = profiler.generate_personality_profile(
            combined_df, '2', sample_recipients_df
        )
    ...
    def test_message_style_classification(self, profiler):
        ...
        long_df = pd.DataFrame({
            ...
            'body': ['This is a very long message that contains a lot of detailed information and goes on for quite a while to demonstrate the long-form writing style that some people prefer when they have a lot to say'] * 3,
