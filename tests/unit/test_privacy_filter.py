...
class TestDataClassification:
    ...
    def test_classify_with_context(self, privacy_filter):
        ...
        # Without context
        normal_level = privacy_filter.classify_data(text)
...
class TestEdgeCases:
    ...
    def test_none_values_in_dataframe(self, privacy_filter):
        ...
        df = pd.DataFrame({
            'body': ["message1", None, "message3"],
            'e164': ["+15551234567", None, "+15551234569"]
        })
        field_mapping = {
            'body': PrivacyLevel.CRITICAL,
            'e164': PrivacyLevel.CRITICAL
...
class TestPerformance:
    ...
    def test_many_patterns_performance(self, privacy_filter):
        ...
        sensitive_patterns = [
            "555-123-4567", "user@example.com", "123-45-6789",
            "4111 1111 1111 1111", "sk-1234567890abcdef1234567890abcdef",
            "192.168.1.1"
        ]
...
class TestPrivacyFilterIntegration:
    ...
    def test_privacy_pipeline_end_to_end(self):
        ...
        # Assertions
        assert all(v['is_anonymized'] or v['anonymization_ratio'] == 0.0 for v in validation_results)
