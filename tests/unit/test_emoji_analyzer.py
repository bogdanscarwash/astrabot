...
class TestEmojiAnalyzer:
    ...
    def test_sentiment_scoring(self, analyzer):
        ...
        positive_scores = [e['sentiment_score'] for e in positive_emojis if e['emotion_category'] != 'other']
        ...
        negative_scores = [e['sentiment_score'] for e in negative_emojis if e['emotion_category'] != 'other']
        ...
        neutral_scores = [e['sentiment_score'] for e in neutral_emojis if e['emotion_category'] != 'other']
