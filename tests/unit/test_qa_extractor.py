...
class TestQAExtractor:
    ...
    def sample_qa_conversation(self):
        ...
        return [
            {"sender": "Alice", "text": "What is machine learning?", "timestamp": base_time},
            {
                "sender": "You",
    ...
    def test_extract_follow_up_questions(self, extractor):
        ...
        conversation = [
            ...
            {
                "sender": "Alice",
                "text": "And what about Kubernetes?",
                "timestamp": datetime.now() + timedelta(minutes=1),
            },
            {
                "sender": "You",
                "text": "Kubernetes orchestrates Docker containers.",
    ...
    def test_extract_implicit_questions(self, extractor):
        ...
        conversation = [
            ...
            {
                "sender": "Alice",
                "text": "Still confused about the base case",
                "timestamp": datetime.now() + timedelta(minutes=1),
            },
            {
                "sender": "You",
                "text": "The base case stops the recursion from continuing forever.",
                "timestamp": datetime.now() + timedelta(minutes=1, seconds=30),
            },
        ]
    ...
    def test_unanswered_questions(self, extractor):
        ...
        conversation = [
            ...
            {
                "sender": "Alice",
                "text": "Also, where is it?",
                "timestamp": datetime.now() + timedelta(seconds=30),
            },
            {
                "sender": "You",
                "text": "I'm not sure, let me check.",
                "timestamp": datetime.now() + timedelta(minutes=1),
            },
            {
                "sender": "Bob",
    ...
    def test_multi_turn_qa(self, extractor):
        ...
        conversation = [
            ...
            {
                "sender": "You",
                "text": "First, you need to initialize a repository with git init.",
                "timestamp": datetime.now() + timedelta(seconds=30),
            },
            {
                "sender": "Alice",
            ...
            {
                "sender": "You",
                "text": "Then add files with git add and commit with git commit.",
                "timestamp": datetime.now() + timedelta(minutes=1, seconds=30),
            },
            {
                "sender": "Alice",
                "text": "How do I push to GitHub?",
                "timestamp": datetime.now() + timedelta(minutes=2),
            },
            {
                "sender": "You",
                "text": "Use git remote add origin [url] then git push -u origin main.",
