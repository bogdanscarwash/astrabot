...
class TestMetadataEnricher:
    ...
    def test_enrich_with_mentions(self, enricher):
        ...
        message = {"text": "Hey @alice and @bob, check this out!", "timestamp": datetime.now()}
    ...
    def test_enrich_with_emojis(self, enricher):
        ...
        message = {"text": "Great job! 👍 😊 🎉", "timestamp": datetime.now()}
    ...
    def test_enrich_with_questions(self, enricher):
        ...
        question_msg = {
            "text": "What do you think about this? Is it good?",
            "timestamp": datetime.now(),
        }
    ...
    def test_enrich_with_link_preview(self, mock_get, enricher):
        ...
        message = {"text": "Read this: https://example.com/article", "timestamp": datetime.now()}
