...
from src.models.schemas import EnhancedMessage, ImageDescription, TweetContent
...
class TestConversationProcessor:
    ...
    def test_inject_tweet_context(self):
        ...
        tweet_data = {"text": "This is a test tweet", "author": "testuser", "tweet_id": "123"}
...
class TestConversationTracking:
    ...
    def test_batch_image_description_structure(self):
        ...
        from src.models.schemas import BatchImageDescription, ImageWithContext
        ...
        batch_desc = BatchImageDescription(image_context=img_context, description=img_desc)
...
class TestDataPipeline:
    ...
    def recipients_df(self):
        ...
        return pd.DataFrame({"_id": [2, 3], "profile_given_name": ["You", "Friend"]})

    def test_message_filtering(self, messages_df):
        """Test filtering messages for processing"""
        # Filter for meaningful messages
        filtered = messages_df[(messages_df["body"].notna()) & (messages_df["body"].str.len() > 5)]
