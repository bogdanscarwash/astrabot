    ...
    return [
        {
            ...
            "response": {"text": "How are you?", "timestamp": 1234567892},
            "metadata": {
                "momentum": "rapid",
                "context_size": 2,
                "avg_time_gap": 1.0,
        ...
        },
        {
            ...
            "context": [
                {
                    "speaker": "You",
                    "text": "Working on something interesting",
                    "timestamp": 1234567900,
                },
                {"speaker": "Other", "text": "What kind of project?", "timestamp": 1234567960},
            ],
            "response": {"text": "A machine learning project", "timestamp": 1234568020},
            "metadata": {
                "momentum": "moderate",
                "context_size": 2,
                "avg_time_gap": 60.0,
...
def sample_tweet_data():
    ...
    return {
        ...
        "metrics": {"replies": 10, "retweets": 25, "likes": 50},
        "images": [
...
def assert_dataframe_structure(df, expected_columns, expected_length=None):
    ...
    ), f"Columns mismatch: {list(df.columns)} != {expected_columns}"
...
def assert_no_sensitive_data(text, sensitive_patterns):
    ...
    for pattern_type, patterns in sensitive_patterns.items():
        for pattern in patterns:
            assert (
                pattern not in text
            ), f"Sensitive {pattern_type} pattern '{pattern}' found in text"
