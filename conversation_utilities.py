...
def extract_tweet_text(url: str) -> Optional[Dict[str, str]]:
    """
    ...
    Returns:
        Dict with 'text', 'author', 'tweet_id' or None if extraction fails
    """
...
def describe_tweet_images(image_urls: List[str], api_endpoint: str, api_key: Optional[str] = None) -> List[str]:
    """
        ...
        try:
            ...
            try:
                ...
                if api_endpoint == 'openai' and api_key:
                    description = _describe_with_openai(tmp_path, api_key)
...
def _describe_with_openai(image_path: str, api_key: str) -> str:
    """Helper function for OpenAI Vision API"""
    import base64
